...
(function() {
    ...
    function init() {
        ...
        function createPipeCaseModel(pipeOD, caseOD) {
            ...
            if (pipeOD > caseOD) {
                document.getElementById('statusMsg').innerHTML = '⚠️ Ошибка: труба больше футляра';
                return null;
            } else {
            ...
            for (let p of ['leftArrow1','leftArrow2','rightArrow1','rightArrow2']) model.paths[p].layer = 'green';
            // Текст
